...
// partition states (master, replica, read-only, etc), multi-level
// containment hierarchy (shelf/rack/zone/datacenter awareness) with
// configurable inclusion/exclusion policies, heterogeneous partition
// weights, heterogeneous node weights, partition stickiness control,
// and multi-master support.
package blance
